...
export class UserStatusController {
    ...
    static async createInterview(req, res) {
        try {
            ...
            const interview = await UserService.createInterview(interviewer.data?.id || '', candidateId);
            res.json({
                success: true,
                data: interview,
            });
    ...
    static async addFeedback(req, res) {
        try {
            ...
            const interview = await UserService.addInterviewFeedback(interviewId, feedback);
            res.json({
                success: true,
                data: interview,
            });
    ...
    static async getUserInterviews(req, res) {
        try {
            ...
            const interviews = await UserService.getUserInterviews(user.data?.id || '');
            res.json({
                success: true,
                data: interviews,
            });
