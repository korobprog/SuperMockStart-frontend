...
app.listen(PORT, () => {
    ...
    console.log(`📱 Telegram Bot: ${process.env.BOT_USERNAME || 'SuperMock_bot'}`);
...
try {
    ...
    console.log('   Run: mkdir ssl && openssl req -x509 -newkey rsa:4096 -keyout ssl/key.pem -out ssl/cert.pem -days 365 -nodes -subj "//C=US/ST=State/L=City/O=Organization/CN=localhost"');
}
// Graceful shutdown
