...
// Завершение интервью
router.put('/interviews/:interviewId/complete', UserStatusController.completeInterview);
// Добавление обратной связи
router.post('/interviews/:interviewId/feedback', UserStatusController.addFeedback);
